      ...
      <section className="container max-w-4xl mx-auto mb-12">
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <Link href="https://visual-tree-search.pathonai.org/" className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">
                <span className="mr-2">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <Link href="https://www.youtube.com/watch?v=FCvxPH21Iwc" className="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors">
                <span className="mr-2">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {/* Video Demo Section */}
        ...
        <div className="aspect-w-16 aspect-h-9 mb-4">
          <iframe 
            ...
            src="https://www.youtube.com/embed/FCvxPH21Iwc"
